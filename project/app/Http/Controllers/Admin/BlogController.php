...
class BlogController extends AdminBaseController
{
    ...
    public function datatables()
    {
        ...
        return Datatables::of($datas)
            ...
            ->editColumn('photo_1', function (Blog $data) {
                $photo = $data->photo_1 ? url('assets/images/blogs/' . $data->photo_1) : url('assets/images/noimage.png');
                return '<img src="' . $photo . '" alt="Image">';
            })
            ...
            ->rawColumns(['photo', 'photo_1', 'action'])
    ...
    public function store(Request $request)
    {
        ...
        $rules = [
            ...
            'photo_1'      => 'required|mimes:jpeg,jpg,png,svg',
        ];
    ...
    public function update(Request $request, $id)
    {
        ...
        $rules = [
            ...
            'photo_1'      => 'mimes:jpeg,jpg,png,svg',
        ];
        ...
        if ($file = $request->file('photo_1')) {
            ...
            if ($data->photo_1 != null) {
                if (file_exists(public_path() . '/assets/images/blogs/' . $data->photo_1)) {
                    unlink(public_path() . '/assets/images/blogs/' . $data->photo_1);
                }
            }
            $input['photo_1'] = $name;
        }
