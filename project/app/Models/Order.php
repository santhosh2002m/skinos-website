...
class Order extends Model
{
    ...
    public static function getMixMatchShipData($cart)
    {
        $vendor_shipping_id = 0;
        $user = array();
        foreach ($cart->items as $prod) {
    ...
    public static function getMixMatchPackingData($cart)
    {
        $vendor_packing_id = 0;
        $user = array();
        foreach ($cart->items as $prod) {
