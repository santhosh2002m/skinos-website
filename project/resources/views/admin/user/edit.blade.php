										...
										<div class="product-description">
											...
											<form id="geniusformdata" action="{{ route('admin-user-edit',$data->id) }}" method="POST" enctype="multipart/form-data">
												...
												<div class="row">
													<div class="col-lg-4">
														<div class="left-area">
																<h4 class="heading">{{ __("HCP Clinic Name") }} </h4>
														</div>
													</div>
													<div class="col-lg-7">
														<input type="text" class="input-field" name="hcp_clinic_name" placeholder="{{ __("HCP Clinic Name") }}" value="{{ $data->hcp_clinic_name ?? '' }}">
													</div>
												</div>
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<input type="text" class="input-field" name="doctor_name" placeholder="{{ __("Doctor Name") }}" value="{{ $data->doctor_name ?? '' }}">
													</div>
												</div>
												...
												<div class="row">
													<div class="col-lg-4">
														<div class="left-area">
																<h4 class="heading">{{ __("Doctor Qualification") }} </h4>
														</div>
													</div>
													<div class="col-lg-7">
														<input type="text" class="input-field" name="doctor_qualification" placeholder="{{ __("Doctor Qualification") }}" value="{{ $data->doctor_qualification ?? '' }}">
													</div>
												</div>
												...
												<div class="row">
													<div class="col-lg-4">
														<div class="left-area">
																<h4 class="heading">{{ __("Preferred Type") }} </h4>
														</div>
													</div>
													<div class="col-lg-7">
														<input type="text" class="input-field" name="preferred_type" placeholder="{{ __("Preferred Type") }}" value="{{ $data->preferred_type ?? '' }}">
													</div>
												</div>
