                                            ...
                                            <div class="row">
                                                    ...
                                                    <div class="table-responsive show-table">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <tr>
                                                                <th>{{ __("HCP Clinic Name") }}</th>
                                                                <td>{{ $data->hcp_clinic_name ?? 'N/A' }}</td>
                                                            </tr>
                                                            <tr>
                                                                <th>{{ __("Doctor Name") }}</th>
                                                                <td>{{ $data->doctor_name ?? 'N/A' }}</td>
                                                            </tr>
                                                            <tr>
                                                                <th>{{ __("Doctor Qualification") }}</th>
                                                                <td>{{ $data->doctor_qualification ?? 'N/A' }}</td>
                                                            </tr>
                                                            <tr>
                                                                <th>{{ __("Preferred Type") }}</th>
                                                                <td>{{ $data->preferred_type ?? 'N/A' }}</td>
                                                            </tr>
                                                        </table>
                                                        </div>
                                                    </div>
