...
<input type="hidden" id="headerdata" value="{{strtoupper($country->country_name)}} / {{ __('STATE TAX') }}">
            <div class="content-area">
              <div class="mr-breadcrumb">
                <div class="row">
                  <div class="col-lg-12">
                      <h4 class="heading"><u>{{ __($country->country_name) }}</u> / {{ __('GST') }} <a class="add-btn" href="{{route('admin-country-tax')}}"><i class="fas fa-arrow-left"></i> {{ __('Back') }}</a></h4>
                      <ul class="links">
                        <li>
                        ...
                        <li>
                          <a href="{{route('admin-country-index')}}">{{ __('Manage GST') }} </a>
                        </li>
                        <li>
                          <a href="javascript:;">{{ __('GST') }}</a>
                        </li>
