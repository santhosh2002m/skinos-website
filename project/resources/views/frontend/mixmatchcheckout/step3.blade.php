    ...
    <div class="gs-checkout-wrapper">
        <div class="container">
            ...
            <form class="address-wrapper checkoutform" method="POST">
                        ...
                        <div class="summary-box">
                            ...
                            <div class="summary-inner-box">
                                ...
                                <div class="details-wrapper">
                                    ...
                                    @if (Auth::user())
                                        ...
                                        <div id="cashback-warning" class="mt-1" style="display: none;color:#004fae;">
                                            <small><strong>Note:</strong> Selecting this option will reduce your cashback by <strong>2%</strong>.</small>
                                        </div>
                                    @endif
                                    {{-- <div class="price-details tax_show d-none">
                                        <span>@lang('GST')</span>
                                    ...
                                    @if ($digital == 0)
                                        ...
                                        {{-- <div class="price-details">
                                            ...
                                            <span
                                                class="right-side">{{ App\Models\Product::convertPrice($shipping_cost) }}</span>
                                        </div>
                                        ...
                                        <div class="price-details">
                                            ...
                                            <span
                                                class="right-side packing_cost_view">{{ App\Models\Product::convertPrice($packing_cost) }}</span>
                                        </div> --}}
                                    @endif
                                </div>
                                ...
                                <div class="final-price">
                                    <span>@lang('Total Amount Payablee')</span>
                            ...
                            <div class="summary-inner-box">
                                <div class="btn-wrappers">
                                    ...
                                    {{-- chnage from step 2 to step 1 --}}
                                    <a href="{{ route('user-mix_match_checkout') }}"
                                        class="template-btn dark-outline w-100">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="24"
                                            viewBox="0 0 25 24" fill="none">
                ...
                <input type="hidden" name="is_mixandmatch" value="true">
                ...
                @else
                    <input type="hidden" name="total" id="grandtotal"
                        value="{{ round($step2->total * $curr->value, 2) }}">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            function updateCashbackBasedOnPayment(paymentTime) {
                ...
                redeemCheckbox.data('percentage', CBPercentage); // Update data attribute
                ...
                $('#cashbackAmountTobeCredited').text(formatCurrency(cashbackAmount.toFixed(2)));
