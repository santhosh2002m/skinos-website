...
Route::group(['prefix' => 'user'], function () {
    ...
    Route::group(['middleware' => 'auth:api'], function () {
        ...
        Route::prefix('cart')->group(function () {
            Route::get('view', 'Api\Front\CartController@cartview');
            Route::post('add/{id}', 'Api\Front\CartController@addcart');
            Route::post('add-mix-and-match', 'Api\Front\CartController@addMixAndMatchToCart');
            Route::post('increment', 'Api\Front\CartController@addbyone');
            Route::post('decrement', 'Api\Front\CartController@reducebyone');
            Route::post('update-color', 'Api\Front\CartController@upcolor');
            Route::delete('remove', 'Api\Front\CartController@removecart');
            Route::delete('remove-mix-and-match', 'Api\Front\CartController@removeMixAndMatchBatch');
            Route::get('/', 'Api\Front\CartController@cart');
        });
        //------------ Cart Controller ------------
        //------------ Mix and Match Controller ------------
        Route::get('/scheme-entries', 'Api\User\MixMatchController@schemeEntries');
        Route::get('/scheme-entry', 'Api\User\MixMatchController@fetchSchemeEntry');
        //------------ Mix and Match Controller ------------
    });
});
...
Route::group(['prefix' => 'front'], function () {
    ...
    Route::get('/tags', 'Api\Front\FrontendController@tags');
    Route::get('/discount-slabs', 'Api\Front\FrontendController@discountSlabs');
    Route::get('/blogs', 'Api\Front\FrontendController@blogs');
    Route::get('/pages/{slug}', 'Api\Front\FrontendController@pages');
