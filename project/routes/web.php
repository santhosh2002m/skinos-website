...
Route::prefix('admin')->group(function () {
    ...
    Route::group(['middleware' => 'permissions:brands'], function () {
        ...
        Route::get('/slabs/datatables', 'Admin\DiscountSlabController@datatables')->name('admin-slabs-datatables');
        Route::get('/slabs', 'Admin\DiscountSlabController@index')->name('admin-slabs-index');
        Route::get('/slabs/create', 'Admin\DiscountSlabController@create')->name('admin-slabs-create');
        Route::post('/slabs/create', 'Admin\DiscountSlabController@store')->name('admin-slabs-store');
        Route::get('/slabs/edit/{id}', 'Admin\DiscountSlabController@edit')->name('admin-slabs-edit');
        Route::post('/slabs/edit/{id}', 'Admin\DiscountSlabController@update')->name('admin-slabs-update');
        Route::delete('/slabs/delete/{id}', 'Admin\DiscountSlabController@destroy')->name('admin-slabs-delete');
        Route::get('/slabs/status/{id1}/{id2}', 'Admin\DiscountSlabController@status')->name('admin-slabs-status');

        Route::get('/scheme', 'Admin\SchemeController@index')->name('admin-scheme-index');
        Route::get('/scheme/datatables', 'Admin\SchemeController@datatables')->name('admin-scheme-datatables');
        Route::get('/scheme/create', 'Admin\SchemeController@create')->name('admin-scheme-create');
        Route::post('/scheme/store', 'Admin\SchemeController@store')->name('admin-scheme-store');
        Route::get('/scheme/status/{id1}/{id2}', 'Admin\SchemeController@status')->name('admin-scheme-status');
        Route::get('/scheme/edit/{id}', 'Admin\SchemeController@edit')->name('admin-scheme-edit');
        Route::post('/scheme/update/{id}', 'Admin\SchemeController@update')->name('admin-scheme-update');
        Route::delete('/scheme/delete/{id}', 'Admin\SchemeController@delete')->name('admin-scheme-delete');

        Route::get('/scheme-option/datatables/{scheme}', 'Admin\SchemeOptionController@datatables')->name('admin-scheme-option-datatables');
        Route::get('/manage/scheme-option/{scheme}', 'Admin\SchemeOptionController@manageSchemeOptions')->name('admin-scheme-option-index');
        Route::get('/scheme-option/create/{scheme}', 'Admin\SchemeOptionController@create')->name('admin-scheme-option-create');
        Route::post('/scheme-option/store/{scheme}', 'Admin\SchemeOptionController@store')->name('admin-scheme-option-store');
        Route::get('/scheme-option/status/{id1}/{id2}', 'Admin\SchemeOptionController@status')->name('admin-scheme-option-status');
        Route::get('/scheme-option/edit/{id}', 'Admin\SchemeOptionController@edit')->name('admin-scheme-option-edit');
        Route::post('/scheme-option/update/{id}', 'Admin\SchemeOptionController@update')->name('admin-scheme-option-update');
        Route::delete('/scheme-option/delete/{id}', 'Admin\SchemeOptionController@delete')->name('admin-scheme-option-delete');
    });
    ...
    Route::group(['middleware' => 'permissions:categories'], function () {
        ...
        Route::get('/admin/tags/datatables', [TagController::class, 'datatables'])->name('admin-tag-datatables');
        Route::get('/admin/tags/create', [TagController::class, 'create'])->name('admin-tag-create');
        Route::post('/admin/tags/store', [TagController::class, 'store'])->name('admin-tag-store');
        Route::get('/admin/tags/edit/{id}', [TagController::class, 'edit'])->name('admin-tag-edit');
        Route::post('/admin/tags/update/{id}', [TagController::class, 'update'])->name('admin-tag-update');
        Route::get('/admin/tags/status/{id1}/{id2}', [TagController::class, 'status'])->name('admin-tag-status');
        Route::delete('/admin/tags/delete/{id}', [TagController::class, 'destroy'])->name('admin-tag-delete');

        Route::get('cashbacks', [CashbackController::class, 'index'])->name('admin-cashback-index');
        Route::get('cashbacks/datatable', [CashbackController::class, 'datatables'])->name('admin-cashback-datatables');
        Route::get('cashbacks/create', [CashbackController::class, 'create'])->name('admin-cashback-create');
        Route::post('cashbacks', [CashbackController::class, 'store'])->name('admin-cashback-store');
        Route::get('cashbacks/{id}/edit', [CashbackController::class, 'edit'])->name('admin-cashback-edit');
        Route::put('cashbacks/{id}', [CashbackController::class, 'update'])->name('admin-cashback-update');
        Route::delete('cashbacks/{id}', [CashbackController::class, 'destroy'])->name('admin-cashback-destroy');
    ...
    Route::group(['middleware' => 'permissions:customers'], function () {
        ...
        // Sales Rep
        Route::post('/user/send-otp/{id}', 'Admin\UserController@sendLoginOtp')->name('admin-user-send-otp');
        Route::post('/user/verify-otp/{id}', 'Admin\UserController@verifyLoginOtp')->name('admin-user-verify-otp');
    ...
    Route::group(['middleware' => 'permissions:manage_staffs'], function () {
        ...
        Route::get('/staff/assign-user/{id}', 'Admin\StaffController@assignUsers')->name('admin-staff-assign-user');
        Route::post('/staff/assign-user/{id}', 'Admin\StaffController@storeAssignUsers')->name('admin-assign-user-store');
    });
...
Route::group(['middleware' => 'maintenance'], function () {
    ...
    Route::prefix('user')->group(function () {
        ...
        Route::get('/discover', 'Auth\User\FrontendController@discover')->name('front.discover');
        ...
        //  --------------------- Reward Point Route ------------------------------//
        Route::get('/mix-and-match/product/datatables', 'User\MixMatchController@datatables')->name('user-mix-match-datatables'); //JSON REQUEST
        // Route::post('/mix-and-match/cart/submit', 'User\MixMatchController@store')->name('user-mix_match_cart_submit');
        Route::get('/mix-and-match/cart', 'User\MixMatchController@loadcart')->name('user-mix_match_cart');
        Route::get('/mix-and-match', 'User\MixMatchController@index')->name('user-mix_match');
        Route::get('/mix-and-match/checkout', 'User\MixMatchController@checkout')->name('user-mix_match_checkout');
        Route::post('/mix-and-match/checkout/step1/submit', 'User\MixMatchController@checkoutStep1')->name('user-mix_match_checkout.step1.submit');
        Route::get('/mix-and-match/checkout/step2', 'User\MixMatchController@checkoutstep3')->name('user-mix_match_checkout.step2');
        Route::get('/mix-and-match/checkout/payment/return', 'User\MixMatchController@payreturn')->name('mix_match.payment.return');
        Route::get('/mix-and-match/checkout/payment/cancle', 'User\MixMatchController@paycancle')->name('mix_match.payment.cancle');

        // User Resetregister.blade
        ...
        // User Wishlist
        // Route::get('/wishlists', 'User\WishlistController@wishlists')->name('user-wishlists');
        // Route::post('/wishl ist/add/{id}', 'User\WishlistController@addwish')->name('user-wishlist-add');
        // Route::delete('/wishlist/remove/{id}', 'User\WishlistController@removewish')->name('user-wishlist-remove');

        Route::get('/wishlists', 'User\WishlistController@wishlists')->name('user-wishlists');
        Route::post('/wishlist/add/{id}', 'User\WishlistController@addwish')->name('user-wishlist-add');
        Route::delete('/wishlist/remove/{id}', 'User\WishlistController@removewish')->name('user-wishlist-remove');
        ...
        // Rename /deposit/index to /cashback/index for UX 
        Route::get('/cashback/transactions', 'User\DepositController@transactions')->name('user-transactions-index');
        Route::get('/cashback/transactions/{id}/show', 'User\DepositController@transhow')->name('user-trans-show');
        Route::get('/cashback/index', 'User\DepositController@index')->name('user-deposit-index');
        Route::get('/cashback/create', 'User\DepositController@create')->name('user-deposit-create');
...
Route::get('/contact/refresh_code', 'Front\FrontendController@refresh_code');
    ...
    Route::post('/carts-json', 'Front\CartController@cartjson')->name('front.cart.json');
    ...
    // // Mix and Match
    Route::post('/mix-and-match/cart/submit', 'Front\CartController@addMixAndMatchToCart')->name('user-mix_match_cart_submit');
    // CART SECTION ENDS
    ...
    // Due to Non Requireemnt We are skipping the second step
...
// We have converted the step 3 to step2
    // Route::get('/checkout/step3', 'Front\CheckoutController@checkoutstep3')->name('front.checkout.step3');
    Route::get('/checkout/step2', 'Front\CheckoutController@checkoutstep3')->name('front.checkout.step2');
    ...
    // Pay On Credit
    Route::post('/checkout/payment/payincredit', 'Payment\Checkout\PayOnCreditController@store')->name('front.payincredit.submit');
